...
export class VcController {
  ...
  @ApiResponse({ status: 201, description: 'Документ успішно створено та підписано' })
   ...
   */
  @Get('org/:orgId')
  @ApiOperation({ summary: 'Отримати всі активні документи конкретної організації' })
   ...
   */
  @Get(':id')
  @ApiOperation({ summary: 'Отримати детальні дані конкретного документа за ID' })
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Локальне видалення документа (зміна статусу на DELETED)' })
